...
def parse_opt(known=False):
    ...
    parser.add_argument('--image-weights', action='store_true', help='use weighted image election for training')
    ...
    parser.add_argument('--name', default='light_yolov5s_results', help='save to project/name')
