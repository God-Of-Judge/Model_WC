...
def init_args():
    ...
    parser.add_argument('--image_path', type=str, default="./data/tusimple_test_image/0.jpg",help='The image path or the src image save dir')
    parser.add_argument('--weights_path', type=str, default="./path/to/your/ckpt",help='The model weights path')
...
def test_lanenet(image_path, weights_path, with_lane_fit=True):
    ...
    :return:
    """
    assert ops.exists(image_path), '{:s} not exist'.format(str(image_path))
