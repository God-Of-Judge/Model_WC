...
python tools/evaluate_lanenet_on_tusimple.py --image_dir data/training_data_example/image --weights_path data/ckpt_file/ --save_dir data/training_data_example/output
python tools/test_lanenet.py --weights_path data/ckpt_file/ --image_path ./data/tusimple_test_image/0.jpg
"""
import argparse
import glob
import os
